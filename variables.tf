...
variable "aws_profile" {
  type        = string
  default     = null
  description = "Perfil local opcional"
}
...
variable "auth_frontend_bucket_name" {
  type = string
}
...
variable "inventario_image" {
  type = string
}
variable "reportes_image" {
  type = string
}
variable "auth_image" {
  type = string
...
variable "inventario_port" {
  type    = number
  default = 3000
}
variable "reportes_port" {
  type    = number
  default = 3001
}
variable "auth_port" {
...
variable "desired_count_inventario" {
  type    = number
  default = 1
}
variable "desired_count_reportes" {
  type    = number
  default = 1
}
...
variable "acm_certificate_arn" {
  ...
  default     = "" # Puedes dejarlo vacío si no usas dominio personalizado
}