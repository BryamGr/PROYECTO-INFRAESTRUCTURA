...
variable "frontend_bucket_name" {
  type        = string
  default     = null
  description = "Nombre del bucket S3 que sirve el frontend principal"
}
variable "auth_frontend_bucket_name" {
  type        = string
  default     = null
  description = "Bucket S3 con la SPA de autenticación"
}
variable "uploads_bucket_name" {
  type        = string
  default     = null
  description = "Bucket S3 para archivos subidos por los usuarios"
}
